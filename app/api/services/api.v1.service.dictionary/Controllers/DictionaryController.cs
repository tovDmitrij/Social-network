...
namespace api.service.dictionary.Controllers
{
    /// <summary>
    ...
    public sealed class DictionaryController : ControllerBase
    {
        ...
        /// </summary>
        private readonly IDictionaryWrapper _dictWrapper;

        public DictionaryController(IDictionaryWrapper db) => _dictWrapper = db;
        ...
        public IActionResult GetLanguage(int lang_id) => _dictWrapper.Langs.IsLanguageExist(lang_id) ?
            StatusCode(200, new 
            { 
                status = "Информация о языке была успешно сформирована", 
                data = _dictWrapper.Langs.GetLanguage(lang_id) 
            }) :
            StatusCode(404, new 
            { 
        ...
        {
            var languages = _dictWrapper.Langs.GetLanguages();
        ...
        public IActionResult GetLifePosition(int pos_id) => _dictWrapper.Positions.IsLifePositionExist(pos_id) ?
            StatusCode(200, new 
            { 
                status = "Информация о жизненной позиции была успешно сформирована", 
                data = _dictWrapper.Positions.GetLifePosition(pos_id) 
            }) :
            StatusCode(404, new 
            { 
        ...
        {
            if (!_dictWrapper.Positions.IsLifePositionTypeExist(type_id))
            {
            ...
            var positions = _dictWrapper.Positions.GetLifePositions(type_id);
        ...
        {
            var positions = _dictWrapper.Positions.GetLifePositions();
            return positions.Any() ?
                StatusCode(200, new 
                { 
                    status = "Список жизненных позиций был успешно сформирован", 
        ...
        public IActionResult GetCity(int city_id) => _dictWrapper.Places.IsCityExist(city_id) ?
            StatusCode(200, new 
            { 
                status = "Информация о городе была успешно сформирована", 
                data = _dictWrapper.Places.GetCity(city_id) 
            }) :
            StatusCode(404, new 
            { 
        ...
        {
            if (!_dictWrapper.Places.IsCityExist(city_id))
            {
                return StatusCode(404, new
                {
                    status = "Города с заданным идентификатором не существует"
            ...
            if (!_dictWrapper.Places.IsRegionExist(region_id))
            {
                return StatusCode(404, new
                {
            ...
            if (!_dictWrapper.Places.IsCityExistInRegion(city_id, region_id))
            {
                return StatusCode(404, new
                {
        ...
        public IActionResult GetCityByCountry(int city_id, int country_id)
        {
            ...
            if (!_dictWrapper.Places.IsCountryExist(country_id))
            {
                return StatusCode(404, new 
                { 
            ...
            if (!_dictWrapper.Places.IsCityExistInCountry(city_id, country_id))
            {
                return StatusCode(404, new
                {
        ...
        {
            var cities = _dictWrapper.Places.GetCities();
            return cities.Any() ?
                StatusCode(200, new 
                { 
        ...
        public IActionResult GetCitiesByRegion(int region_id)
        {
            ...
            var cities = _dictWrapper.Places.GetCitiesByRegion(region_id);
            return cities.Any() ?
                StatusCode(200, new 
                { 
                    status = "Список городов был успешно сформирован", 
        ...
        public IActionResult GetCitiesByCountry(int country_id)
        {
            ...
            var cities = _dictWrapper.Places.GetCitiesByCountry(country_id);
            return cities.Any() ?
                StatusCode(200, new 
                { 
                    status = "Список городов был успешно сформирован", 
        ...
        public IActionResult GetRegion(int region_id) => _dictWrapper.Places.IsRegionExist(region_id) ?
            StatusCode(200, new 
            { 
                status = "Информация о регионе была успешно сформирована", 
                data = _dictWrapper.Places.GetRegion(region_id) 
            }) :
            StatusCode(404, new 
            { 
                status = "Региона с заданным идентификатором не существует" 
        ...
        public IActionResult GetRegionByCountry(int region_id, int country_id)
        {
            ...
            if (!_dictWrapper.Places.IsRegionExistInCountry(region_id, country_id))
            {
                return StatusCode(404, new
                {
        ...
        {
            var regions = _dictWrapper.Places.GetRegions();
            return regions.Any() ?
                StatusCode(200, new 
                { 
        ...
        public IActionResult GetRegionsByCountry(int country_id)
        {
            ...
            var regions = _dictWrapper.Places.GetRegionsByCountry(country_id);
            return regions.Any() ?
                StatusCode(200, new 
                { 
                    status = "Список регионов был успешно сформирован", 
        ...
        public IActionResult GetCountry(int country_id) => _dictWrapper.Places.IsCountryExist(country_id) ?
            StatusCode(200, new 
            { 
                status = "Информация о стране была успешно сформирована", 
                data = _dictWrapper.Places.GetCountry(country_id) 
            }) :
            StatusCode(404, new 
            { 
                status = "Страны с заданным идентификатором не существует" 
        ...
        {
            var countries = _dictWrapper.Places.GetCountries();
        ...
        public IActionResult GetFamilyStatus(int status_id) => _dictWrapper.Families.IsStatusExist(status_id) ?
            StatusCode(200, new 
            {
                status = "Информация о семейном положении была успешно сформирована", 
                data = _dictWrapper.Families.GetStatus(status_id) 
            }) :
            StatusCode(404, new 
            { 
        ...
        {
            var statuses = _dictWrapper.Families.GetStatuses();
            return statuses.Any() ?
                StatusCode(200, new 
                { 
